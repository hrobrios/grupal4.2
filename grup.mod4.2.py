...
class Vendedor:
    ...
    def venta(self,producto):#la palabra producto es generica y puede cualquier otra. es solo para hacer referencia a los productos que se crearon
        neto=producto.valor_neto
        #self.comision=porcentaje_comision*neto
